...
LayerTechnologyWeb frameworkFlaskRAG orchestrationLangChainVector storeChromaDBLLMLlama 3.1 8B via OllamaDatabasePostgreSQLContainerizationDocker ComposeCloudAWS EC2 (t3.xlarge)
